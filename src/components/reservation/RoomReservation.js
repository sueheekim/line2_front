                ...
                <div className={'row center'}>
                    <div>
                        ...
                        <p className={'reservation_content_2'}>
                            {checkIn.getFullYear()}년 {checkIn.getMonth() + 1}월{' '}
                            {checkIn.getDate()}일
                        </p>
                        <p className={'reservation_content_3'}>
                            {checkIn.getHours()}:00 ~
                        </p>
                    </div>
                    <div>
                        ...
                        <p className={'reservation_content_2'}>
                            {checkOut.getFullYear()}년 {checkOut.getMonth() + 1}
                            월 {checkOut.getDate()}일
                        </p>
                        <p className={'reservation_content_3'}>
                            ~ {checkOut.getHours()}:00
                        </p>
                    </div>
                    <div>
                    ...
                    <button
                        className={'reservation_change_button'}
                ...
                <table className={'reservation_table'}>
                    <thead>
                        <tr>
                            ...
                            <th className={'table_room_gender'}>
                                입실 가능 성별
                            </th>
                            <th className={'table_room_max_head_count'}>
                                정원
                            </th>
                            <th className={'table_room_available'}>
                                남은 자리
                            </th>
